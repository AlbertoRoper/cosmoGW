"""
modified_grav.py is a Python routine that contains functions relevant
...
def parameterizations_alpM(eta, alpM0=1., a=[], Omega=[], Omega_mat=[], OmM0=0, choice='0', n=1):
    ...
    alpha_M. Reference is HRPB23, equation 4.2.
...
def damping_fact(eta, alpM, HH):
    ...
    Reference is HRPB23, equation 2.5.
...
def DeltaT(eta, alpT):
    ...
    Reference is HRPB23, equation 3.4.
...
def sol_WKB(k, eta, HH, DD, eta_ini=1, h0=[0], g0=[0], alpM=[0], alpT=[0], alpM0=0):
    ...
    Reference is HRPB23, equation 3.8
...
def WKB_envelope(k, eta, HH, DD, alpM=[0], alpT=[0], alpM0=0):
    ...
    Reference is HRPB23, equation 3.20.
...
def WKB_envelope_late_times(k, DD=0, alpT=0, alpM0=0):
    ...
    Reference is HRPB23, equation 3.21.
...
def WKB_slopes(k, alpM):
    ...
    is tangent to the spectrum at k. Reference is HRPB23, equation 5.4.
