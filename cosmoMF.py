"""
cosmoMF.py is a Python routine that contains functions relevant for
...
RPNCBS23 - A. Roper Pol, A. Neronov, C. Caprini, T. Boyer, D. Semikoz, "LISA and γ-ray
telescopes as multi-messenger probes of a first-order cosmological phase transition,"
arXiv:2307.10744 (2023)

HS22 - D. Hosking, A. Schekochihin, "Cosmic-void observations reconciled with
primordial magnetogenesis," arXiv:2203.03573 (2022)

FLC18 - [Fermi-LAT Collaboration], "Search for Spatial Extension in High-Latitude Sources
Detected by the Fermi Large Area Telescope," Astrophys. J. Suppl. 237, 32 (2018),
arXiv:1804.08035

KKNS21 - A. Korochkin, O. Kalashev, A. Neronov, and D. Semikoz, "Sensitivity reach of
gamma-ray measurements for strong cosmological magnetic fields," Astrophys. J. 906,
116 (2021), arXiv:2007.14331

PTU16 - M. S. Pshirkov, P. G. Tinyakov, and F. R. Urban, "New limits on extragalactic
magnetic fields from rotation measures," Phys. Rev. Lett. 116, 191302 (2016),
arXiv:1504.06546

NKS21 - A. Neronov, D. Semikoz, and O. Kalashev, "Limit on intergalactic magnetic
field from ultra-high-energy cosmic ray hotspot in Perseus-Pisces region,"
arXiv:2112.08202 (2021)

GPJB22 - S. Galli, L. Pogosian, K. Jedamzik, and L. Balkenhol, "Consistency of Planck,
ACT and SPT constraints on magnetically assisted recombination and forecasts for future
experiments," Phys.Rev.D 105 2 (2022), 023513, arXiv:2109.03816
...
def B_vs_ll_LPE(ll, T=Tref, cs2=cs2, d=1, A=1, exp=1):
    ...
    Reference: RPCNS22, eq. 52
    
    01/05/23, Alberto Roper Pol: added option to use reconnection time instead of
    Alfven time to relate B vs \lambda, following HS22, used in RPNCBS23
...
def B_vs_ll_rec(ll, T=Tref, cs2=cs2, d=1, A=1, exp=1):
    ...
    B = B_vs_ll_LPE(ll, T=Trec, cs2=cs2, d=d, A=A, exp=exp)
...
def gr_limits(x, exp='Fermi_timing'):
    ...
    Arguments:
        ...
        exp -- reference experiment for the limits:
            ...
            - 'CTA': expected sensitivity of CTA, from KKNS21
            - 'Faraday': upper limit from measures of Faraday rotation, from PTU16
            - 'UHECR': observations from ultra-high energy cosmic rays (UHECR), from NSK21
